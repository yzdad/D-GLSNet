...
from models.backbone.occ.layers import ResnetBlockFC
from models.backbone.occ.common import normalize_coordinate, normalize_3d_coordinate, map2local
...
class LocalDecoder(nn.Module):
    ...
    def __init__(self, dim=3, c_dim=128,
        ...
        self.fc_out = nn.Linear(hidden_size, 256)  # TODO
